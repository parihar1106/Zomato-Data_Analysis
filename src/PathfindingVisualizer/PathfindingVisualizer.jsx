...
export default class PathfindingVisualizer extends Component {
  constructor() {
    ...
    this.state = {
      ...
      isRunning: false,//boolean wether currently algorithm is running or not
      isStartNode: false,
      isFinishNode: false,
  ...
  //need to understand setState properly
  componentDidMount() {
  ...
  /******************** Set up the initial grid ********************/
   // returns the node object for every cell of grid
  createNode = (row, col) => {
    return {
      row,
      col,
   ...
   // returns the grid which is orginally rendered
  getInitialGrid = (
  ...
  // returns wether the grid is clear or not
  isGridClear() {
  ...
  /******************** Clear Board/Walls ********************/
  // makes all the visited nodes unvisited
  clearGrid() {
    if (!this.state.isRunning) {
  ...
  //clears all the nodes which are wall to normal node
  clearWalls() {
    if (!this.state.isRunning) {
      const newGrid = this.state.grid.slice();
      for (const row of newGrid) {
